...
var GameMoveNode = (function () {
    function GameMoveNode(_move, _parentNode) {
        this.nextMinRating = Number.POSITIVE_INFINITY;
        this.nextMaxRating = Number.NEGATIVE_INFINITY;
        this.childrenRated = false;
        this.move = _move;
        this.parentNode = _parentNode;
        this.nextMoves = [];
    }
    Object.defineProperty(GameMoveNode.prototype, "rating", {
        get: function () { return this._rating; },
        set: function (newRating) {
            this._rating = newRating;
            if (this.nextMaxRating < newRating)
                this.nextMaxRating = newRating;
            if (this.nextMinRating > newRating)
                this.nextMinRating = newRating;
            if (this.parentNode)
    ...
    GameMoveNode.prototype.NextRatingChanged = function (min, max) {
        var push = false;
        if (min < this.nextMinRating || !this.childrenRated) {
            this.nextMinRating = min;
            push = true;
        }
        if (max > this.nextMaxRating || !this.childrenRated) {
            this.nextMaxRating = max;
            push = true;
        }
    ...
    GameMoveNode.prototype.AddNextMove = function (move) {
...
var EnemyAIMinimax = (function () {
    ...
    EnemyAIMinimax.prototype.BFS = function () {
        ...
        this.shuffleArray(gameMoveNodeSource.nextMoves).forEach(function (node) {
